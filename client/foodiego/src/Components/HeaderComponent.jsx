            ...
            <header className={`${theme ? 'bg-black text-white' : 'bg-white text-black'} pl-4 shadow-md`}>
                <div className="container mx-auto flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <Link to="/foodieGo/home"className="text-lg hover:underline mr-10">Home</Link>
                    ...
                    <ul className='flex space-x-4 mt-10'>
                        <li><Link to='/foodieGo/cart'className="hover:underline"><BsCartCheck size={24} className='mb-10'/></Link></li>
